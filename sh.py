...
def sh(update: Update, context: CallbackContext) -> None:
    ...
    result = asyncio.run(sh	card(card_input))  # Assuming your function is async
...
"""
            ...
            elif "actionrequiredreceipt" in raw.lower():
                return f"""Card: {full_card}
Status: Approved!✅
