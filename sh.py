...
async def sh(card_input: str):
    ...
    async with aiohttp.ClientSession(connector=connector) as r:
        ...
        headers = {
            ...
            'referer': 'https://www.mymedictr.org/products/donation-product?variant=45827204055194',
        ...
        json_data = {
            ...
            'variables': {
                        ...
                        'deliveryLines': [
                            {
                                'destination': {
                                    'streetAddress': {
                                        ...
                                        'zoneCode': 'NY',
                                        'coordinates': {
                                            'latitude': 40.71985069999999,
                                            'longitude': -73.9904294,           
                                        },
                                    },
                                },
                                'selectedDeliveryStrategy': {
                                    'deliveryStrategyByHandle': {
                                        'handle': '94d66aff305892f7ee07ff8486315cae-56d792b4c704d4319102b82144f46393',
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/45827204055194',
                                        'properties': [
                                            {
                                        ...
                                        'variantId': 'gid://shopify/ProductVariant/45827204055194',                      
                                    },
                                },
                                'quantity': {
                                    'items': {
                ...
                'metafields': [],
                'analytics': {
                    'requestUrl': 'https://www.mymedictr.org/checkouts/cn/{tok}/?auto_redirect=false&edge_redirect=true&locale=en-AU&skip_shop_pay=true',
                    'pageId': '4462430e-54A8-41FE-93FB-FCFC07ACDA4F',
                },
            },
            'operationName': 'SubmitForCompletion',
        }
